<%@ Page Title="" Language="C#" MasterPageFile="~/Associate/Master1.Master" AutoEventWireup="true" CodeBehind="PostAdverrtisementSales.aspx.cs" Inherits="WcrAssociate.Associate.PostAdverrtisementSales" %>
        ...
        $(document).ready(function () {
            ...
            function InsertD() {
                ...
                $.ajax({
                    ...
                    data: "{'CategoryId':'" + CategoryId + "','SubCategoryId':'" + subCategoryId + "','title':'" + txtName.value + "','Features':'" + txtFeatures.value.trim() + "','address':'" + address.trim() + "','email':'" + email + "','contactNo':'" + txtContact.value + "','description':'" + txtdescription.value.trim() + "','countryID':'" + countryID + "','StateID':'" + StateID + "','cityID':'" + cityID + "','address':'" + txtAddress.value.trim() + "','zipcode':'" + txtzipcode.value + "','isFeatured':'" + Isfeatured + "','FeatureID':'" + teamlist + "','jobtype':'1','amount':'" + txtPrice.value + "'}",
            ...
            function BindCategory() {
                $.ajax({
                    type: "POST", url: "ws/Category.asmx/AssociateCategory", data: "{'jobtype':'1'}", contentType: "application/json; charset=utf-8", dataType: "json", async: false,
                    success: function (r) {
                        if (r.d.length > 0) {
                            var xmlDoc = $.parseXML(r.d);
                            var xml = $(xmlDoc);
                            ...
                            <div class="box-body  form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                                            <input type="file" class="form-control" id="FileUpload1" />(Less Than 530Kb and widthXheight=1600X1200)
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                                        Price:- 
                                ...
                                <div class="form-group">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                                        <%-- <input type="checkbox" style="visibility:hidden;" id="chkfeatured" name="IsFeatured" />IsFeatured<br />--%>
                                        <%-- (You have to pay 5$ additional if advertisment is featured)      --%>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                                        <input id="btnSubmit" type="button" class="btn btn-primary" value="Save" />
                                    </div>
                                </div>
                            </div>
                        </div>
