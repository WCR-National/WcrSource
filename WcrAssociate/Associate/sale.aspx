<%@ Page Title="Sale" Language="C#" MasterPageFile="~/Associate/associate.Master" AutoEventWireup="true" CodeBehind="sale.aspx.cs" Inherits="WcrAssociate.Associate.sale" %>
    ...
    <div id="page_content">
        <div class="md-card-content">
            <div id="page_content_inner">
                <a href="Dashboard.aspx">Dashboard </a>-->  <a href="sale.aspx">Sale</a>
                                ...
                                <div class="uk-modal-dialog">
                                    ...
                                    <table class="uk-table uk-table-nowrap">
                                        <thead>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" id="chkfeatured" name="IsFeatured" />IsFeatured<br /> (You have to pay 5$ additional if advertisment is featured) 
                                                </td>
                                                <td>
