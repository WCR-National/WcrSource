...
var ListPropertiesComponent = /** @class */ (function () {
    function ListPropertiesComponent(cdr, route, router, paymentService, xmlToJson, fb, listpropertiesService, purchaseZipCodeService, modalService, ngZone, _lightboxEvent, toaster) {
        ...
        this.isFirstTimePageBindEdit = true;
    ...
    ListPropertiesComponent.prototype.setValidationOnForm = function () {
        ...
        this.PostAdvertisement.valueChanges.subscribe(function (data) {
            var status = false;
            for (var i = 0; i < _this.arrayOfImages.length; i++) {
                if (_this.arrayOfImages[i].previewUrl != '') {
                    status = true;
                }
            }
            if (status) {
                _this.PostAdvertisement.get('image').patchValue(_this.arrayOfImages.toString(), { emitEvent: false });
            }
            else {
                _this.PostAdvertisement.get('image').patchValue('', { emitEvent: false });
            }
        });
    };
    ...
    ListPropertiesComponent.prototype.resetImageFirstTime = function (e1, imageIndex) {
        ...
        var imageObject = { 'srcUrl': l_imageUrlFT, 'previewUrl': l_imageUrlFT, 'imageIndex': imageIndex, 'isDeleted': '' };
            ...
            if (data.d.length > 0) {
                ...
                $.each(docs, function (i, docs) {
                    ...
                    if (($(docs).find("advMainImage").text()) !== undefined && ($(docs).find("advMainImage").text()) != null && ($(docs).find("advMainImage").text()) != "") {
                        ...
                        var imageObject = { 'srcUrl': thisStatus.imageUrl, 'previewUrl': thisStatus.imageUrl, 'imageIndex': '0', isDeleted: '' };
                        ...
                        images += "</div>";
                        images += "</div>";
                        var imageObject = { 'srcUrl': '', 'previewUrl': '', 'imageIndex': '0', isDeleted: '' };
                        thisStatus.arrayOfImages.push(imageObject);
                    }
                    if (($(docs).find("advImage1").text()) !== undefined && ($(docs).find("advImage1").text()) != null && ($(docs).find("advImage1").text()) != "") {
                        ...
                        var imageObject = { 'srcUrl': thisStatus.imageUrl, 'previewUrl': thisStatus.imageUrl, 'imageIndex': '1', isDeleted: '' };
                        thisStatus.arrayOfImages.push(imageObject);
                        ...
                        images += "</div>";
                        images += "</div>";
                        var imageObject = { 'srcUrl': '', 'previewUrl': '', 'imageIndex': '1', isDeleted: '' };
                        thisStatus.arrayOfImages.push(imageObject);
                    }
                    if (($(docs).find("advImage2").text()) !== undefined && ($(docs).find("advImage2").text()) != null && ($(docs).find("advImage2").text()) != "") {
                        ...
                        var imageObject = { 'srcUrl': thisStatus.imageUrl, 'previewUrl': thisStatus.imageUrl, 'imageIndex': '2', isDeleted: '' };
                        thisStatus.arrayOfImages.push(imageObject);
                        ...
                        images += "</div>";
                        images += "</div>";
                        var imageObject = { 'srcUrl': '', 'previewUrl': '', 'imageIndex': '2', isDeleted: '' };
                        thisStatus.arrayOfImages.push(imageObject);
                    }
                    if (($(docs).find("advImage3").text()) !== undefined && ($(docs).find("advImage3").text()) != null && ($(docs).find("advImage3").text()) != "") {
                        ...
                        var imageObject = { 'srcUrl': thisStatus.imageUrl, 'previewUrl': thisStatus.imageUrl, 'imageIndex': '3', isDeleted: '' };
                        thisStatus.arrayOfImages.push(imageObject);
                        ...
                        images += "</div>";
                        images += "</div>";
                        var imageObject = { 'srcUrl': '', 'previewUrl': '', 'imageIndex': '3', isDeleted: '' };
                        thisStatus.arrayOfImages.push(imageObject);
                    }
                    $('#previewImages').html(images);
        ...
        if (this.arrayOfImages[0].previewUrl == '') {
            ...
            this.listpropertiesService
                ...
                if (data.d == "3") {
                    ...
                    debugger;
                    _this.AdvertisementImages(parseInt(advertisementId), "Yes");
    ...
    ListPropertiesComponent.prototype.SavePostAdvertisementsData = function (CategoryId, subCategoryId, title, features, address, contactNo, description, countryID, stateID, cityId, zipcod, isFeatured, jobtype, amount, adsPrice) {
        ...
        this.listpropertiesService
            ...
            if (parseInt(data.d) >= 1) {
                ...
                debugger;
                _this.AdvertisementImages(parseInt(data.d), "No");
            }
            else {
    ...
    ListPropertiesComponent.prototype.AdvertisementImages = function (rowID, isUpdating) {
        //debugger;
        //var thisStatus = this;
        //var test = new FormData();
        //var deletePic1 = '';
    ...
    ListPropertiesComponent.prototype.onclickUpdatePurchase = function () {
        if (this.isPostButtonGreen) {
            this.isPostButtonGreen = false;
        }
        else {
