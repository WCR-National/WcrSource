...
var ConsumerDashabordComponent = /** @class */ (function () {
    function ConsumerDashabordComponent(fb, renderer, searchService, platformId, _messageService, router, dashboardService) {
        var _this = this;
        this.fb = fb;
    ...
    ConsumerDashabordComponent.prototype.ngOnInit = function () {
    ...
    ConsumerDashabordComponent.prototype.initializeFormsAndEvents = function () {
        var _this = this;
    ...
    ConsumerDashabordComponent.prototype.logValidationErrors = function (group) {
        var _this = this;
    ...
    ConsumerDashabordComponent.prototype.onPressEnterSearchData = function () {
        if (!this.errorExist) {
            this.searching();
        }
        //if (txtSearch.value == "") {
    ...
    ConsumerDashabordComponent.prototype.onClickSearch = function () {
    ...
    ConsumerDashabordComponent.prototype.searching = function () {
        this.resultContent = false;
        this.isSearchingStart = true;
        this.isSearchingStartMatIcon = true;
    ...
    // Init
    ConsumerDashabordComponent.prototype.parallaxBG = function () {
    ...
    ConsumerDashabordComponent.prototype.bindSalesCategory = function (zipc, searchByIpOrtxtSearch) {
                                ...
                                $.each(docs_1, function (i, doc) {
                                    ...
                                    if (!data.d.includes("GetCategoriesinfo1")) {
                                        if (flag == 1) { }
                                            ...
                                            // ? ca = 0 & id=" + ($(doc).find("id").text()) + " & zipcode=" + zipc + " & name=" + ($(doc).find("name").text()) + " & jtype=Sales & catName=RealEstate'
                                            console.log(queryToSalesAdvertisementList);
                                            innerHtmlSales += " <div class='grid-item col-lg-3 col-md-4 col-sm-6 col-xs-12 text-center mg-t-30 pd-sm-r-0'>";
                                            innerHtmlSales += "   <div class='card-main white darken-1' >";
    ...
    ConsumerDashabordComponent.prototype.bindServiesCategory = function (zipc, searchByIpOrtxtSearch) {
        if (searchByIpOrtxtSearch === void 0) { searchByIpOrtxtSearch = "txtSearch"; }
        return tslib_1.__awaiter(this, void 0, void 0, function () {
    ...
    ConsumerDashabordComponent.prototype.bindSalesCategoryCityWise = function (state, city) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var innerHtmlSales, thisHomePage;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                                ...
                                $.each(docs, function (i, docs) {
                                            ...
                                            if ($(docs).find("id").text() == $(docs1).find("Subcategoryid").text()) {
                                                ...
                                                $.each(docs1, function (i, docs1) {
                                                    if ($(docs).find("id").text() == $(docs1).find("Subcategoryid").text()) {
                                                        ...
                                                        console.log(queryToSalesAdvertisementList);
                                                        //let urlToSalesAdvertisement: string = 'sales-advertisements?ca=0&id="' + ($(docs).find("id").text()) + '"&zipcode="' + $(docs1).find("Zipcode").text() + '"&name="' + ($(docs).find("name").text()) + '"&jtype=Sales&catName=RealEstate';
                                    ...
                                    if (!data.d.includes('GetCategoriesinfoCity')) {
                                        if (flag == 1) { }
                                            ...
                                            console.log(queryToSalesAdvertisementList);
                                            //let urlToSalesAdvertisement: string = "sales-advertisements?ca=0&id=" + ($(docs).find("id").text()) + "&name=" + ($(docs).find("name").text()) + "&jtype=Sales&catName=RealEstate";
                                            //innerHtmlSales += "<a href='sales-advertisements?ca=0&id=" + ($(docs).find("id").text()) + "&name=" + ($(docs).find("name").text()) + "&jtype=Sales&catName=RealEstate'>";
    ...
    ConsumerDashabordComponent.prototype.bindServiesCategoryCityWise = function (state, city) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var innerHtmlServices, thisHomePage;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
    ...
    ConsumerDashabordComponent.prototype.GetSalesAdts = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var globalThis;
            return tslib_1.__generator(this, function (_a) {
                debugger;
    ...
    ConsumerDashabordComponent.prototype.bindSalesCategoryByIP = function (zipc, searchByIpOrtxtSearch) {
        if (searchByIpOrtxtSearch === void 0) { searchByIpOrtxtSearch = "txtSearch"; }
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var innerHtmlSales, thisHomePage;
            var _this = this;
    ...
    ConsumerDashabordComponent.prototype.bindServiesCategoryByIP = function (zipc, searchByIpOrtxtSearch) {
        if (searchByIpOrtxtSearch === void 0) { searchByIpOrtxtSearch = "txtSearch"; }
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var innerHtmlServices, thisHomePage;
            var _this = this;
    ...
    ConsumerDashabordComponent.prototype.xml2json = function (xml, tab) {
        var X = {
            toObj: function (xml) {
                var o = {};
    ...
    ConsumerDashabordComponent.prototype.sleep = function (delay) {
        var start = new Date().getTime();
        while (new Date().getTime() < start + delay)
            ;
    };
    ConsumerDashabordComponent.prototype.InitializeEvetsClick = function () {
        debugger;
        var thisStatus = this;
        setTimeout(function () {
    ...
    ConsumerDashabordComponent.prototype.InitializeEventsClickServices = function () {
        debugger;
        var thisStatus = this;
        setTimeout(function () {
    ...
    ], ConsumerDashabordComponent.prototype, "divSalesServices", void 0);
    ConsumerDashabordComponent = tslib_1.__decorate([
        Component({
    ...
    return ConsumerDashabordComponent;
}());
export { ConsumerDashabordComponent };
...
//                                        $.each(docs1, function (i, docs1) {
//                                            if ($(docs).find("ID").text() == $(docs1).find("categoryid").text()) {
//                                                let urlToSalesAdvertisementList: string = "sales-advertisements?ca=0&id=" + ($(docs).find("id").text()) + "&zipcode=" + $(docs1).find("Zipcode").text() + "&name=" + ($(docs).find("name").text()) + "&jtype=Sales&catName=RealEstate";
//                                                innerHtmlSales += "<a href='" + urlToSalesAdvertisementList + "'>";
...
//                        if (flag == 1) { }
//                        else {
//                            innerHtmlSales += "<a href='sales-advertisements?ca=0&id=" + ($(docs).find("id").text()) + "&zipcode=" + zipc + "&name=" + ($(docs).find("name").text()) + "&jtype=Sales&catName=RealEstate'>";
...
//                                        $.each(docs1, function (i, docs1) {
//                                            if ($(docs).find("ID").text() == $(docs1).find("categoryid").text()) {
//                                                let urlToServiceProfileList: string = "/service-profile?ca=0&id=" + ($(docs).find("ID").text()) + "&zipcode=" + $(docs1).find("zipcode").text() + "&name=" + ($(docs).find("name").text()) + "&jtype=Services&catName=" + ($(docs).find("categoryName").text()) + "";
...
//                        if (flag == 1) { }
//                        else {
//                            innerHtmlSales += "<a href='/service-profile?ca=0&id=" + ($(docs).find("ID").text()) + "&zipcode=" + zipc + "&name=" + ($(docs).find("name").text()) + "&jtype=Services&catName=RealEstate'>";
...
//                                innerHtmlSales = "<p>" + ($(doc).find("name").text()) + "  </p>";
//                                let urlToSalesAdvertisementList: string = "sales-advertisements?ca=0&id=" + ($(doc).find("id").text()) + "&zipcode=" + $(doc1).find("Zipcode").text() + "&name=" + ($(doc).find("name").text()) + "&jtype=Sales&catName=RealEstate";
//                                //innerHtmlSales += "<a href='" + urlToSalesAdvertisementList + "'>";
//                                innerHtmlSales += "<h3 class='theme-text-color text-center'>" + ($(doc).find("name").text()) + "</h3>";
//                                innerHtmlSales += "<p class='grey-text elipsis-text' style='text-align:left;'>" + ($(doc).find("detail").text()) + "  </p>";
//                                innerHtmlSales += "<a class='waves-effect waves-light btn' href='" + urlToSalesAdvertisementList + "'>View More</a></div></div>";
...
//                            innerHtmlSales += "<h3 class='theme-text-color text-center'>" + ($(doc).find("name").text()) + "</h3>";
//                            innerHtmlSales += "<p class='grey-text elipsis-text' style='text-align:left;'>" + ($(doc).find("detail").text()) + "  </p>";
//                            innerHtmlSales += "<a class='waves-effect waves-light btn' href='sales-advertisements?ca=0&id=" + ($(doc).find("id").text()) + "&zipcode=" + zipc + "&name=" + ($(doc).find("name").text()) + "&jtype=Sales&catName=RealEstate'>View More</a></div></div>";
//                        }
//                    }
//                }
//                else { }
