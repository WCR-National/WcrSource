...
export class encrypt_decrypt {
    ...
    //encode(e) {
    //    var t = ""; var n, r, i, s, o, u, a; var f = 0; e = this._utf8_encode(e); while (f < e.length) {
    //        n = e.charCodeAt(f++);
    ...
    //decode(e) {
    //    var t = ""; var n, r, i; var s, o, u, a; var f = 0; e = e.replace(/++[++^A-Za-z0-9+/=]/, "");
    //    while (f < e.length) {
    ...
    //        var r = e.charCodeAt(n); if (r < 128) { t += String.fromCharCode(r) }
    ...
    //_utf8_decode(e) {
    //    var t = ""; var n = 0; var r = 0; var c1 = 0; var c2 = 0; var c3 = 0;
    //    while (n < e.length) {
    //        r = e.charCodeAt(n); if (r < 128) { t += String.fromCharCode(r); n++ }
